...
15. Visual baselines and axe acceptance use the lockfile-pinned Playwright Chromium. Install it with `npx playwright-core install chromium`; do not silently fall back to a moving system browser.
